...
- Extend `ScBrokerCommand` base class (provides auto-resolution of broker, msgVpnName, sempConn)
...
- For create, update, and delete commands use the Config SEMP API, see [semp-v2-swagger-config.json](semp-v2-swagger-config.json)
